...
for n=1:Ne
  ...
  switch popupmenu5value
    ...
    load ('E:\HSV\v1\training_set\featureout.mat');
    featureout=z;
    %disp(z);
    save ('E:\HSV\v1\training_set\featureout.mat','featureout');
    test
...
clear all
winopen('E:\HSV\v1\training_set\output.txt');
...
contents = get(handles.popupmenu5,'String'); 
  ...
  switch popupmenu5value
      case 'Train using Gradient Technique'
        train
        helpdlg('Network has been trained using Gradient technique. Click on "Extract signature" to process the image',...
...
function pushbutton17_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton17 (see GCBO)
